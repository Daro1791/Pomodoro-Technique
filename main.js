...
const set = document.querySelector("#settingForm");
const taskTimeSet = document.querySelector("#taskTime");
const breakTimeSet = document.querySelector("#breakTime");
